import { c as createComponent, a as createAstro, r as renderTemplate, b as renderSlot, d as renderHead, e as addAttribute } from './astro/server_Dja6Hlxb.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                              */
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"', "><title>Portfolio</title>", '</head> <body class="h-[1900px]"> ', " <!-- Scripts --> <!-- <script>\n			// Importar y ejecutar la funci\xF3n de scroll suave\n			import { setupSmoothScroll } from '../utils/smoothScroll';\n			setupSmoothScroll();\n		<\/script> --> </body></html>"])), addAttribute(Astro2.generator, "content"), renderHead(), renderSlot($$result, $$slots["default"]));
}, "C:/Users/Miguel Castillo/Desktop/Proyectos/Porfolio/MigueDev/src/layouts/Layout.astro", void 0);
...
export { $$Layout as $, getCertificates as a, getCategories as g };
